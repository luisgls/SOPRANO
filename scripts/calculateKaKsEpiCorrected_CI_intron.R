...
cat(paste(paste("ExonicOnly",ALL.extraKaKs,finalLowCI,finalHighCI,N,ALL.intraKaKs,finalLowCI2,finalHighCI2,N2,PVAL,"\t"),"\n"))
...
cat(paste(paste("ExonicIntronic",ALL.extraKaKs,finalLowCI,finalHighCI,N,ALL.intra_intronKaKs,finalLowCI3,finalHighCI3,N3,PVALintron,"\t"),"\n"))
